...
const experience = [
  {
    ...
    period: "Most Recent",
    highlights: [
      "Scaled course portfolio from 3 to 20 offerings, driving company growth by identifying high-demand career paths and leading end-to-end course development and optimization.",
      "Increased student job placements by 20% by designing, launching a self-service coaching marketplace.",
      "Improved course profitability by restructuring instructor contracts, increasing profit per sale 25% by aligning payouts with delivered value.",
      "Managed a team of 2 employees, recruited 20 high-level contracted instructors, and managed over 50 3rd party tutors.",
    ],
  },
  {
    company: "JL Productions - JL Sponsorships",
    location: "Las Vegas",
    role: "COO",
    dates: "September 2022 - December 2022",
    period: "Previous",
    highlights: [
      "Increased the active creator roster by 200% by refining the company’s positioning and developing a more focused partnership strategy.",
      "Increased total sponsorship value secured by 300% through targeted brand outreach, deal negotiation, and partnership execution.",
    ],
  },
  {
    company: "JL Productions - Hungry Bull",
    location: "Las Vegas",
    role: "Co-Founder/COO",
    dates: "December 2020 - August 2022",
    period: "Venture",
    highlights: [
      "Co-founded fintech media app with Graham Stephen, reaching 100K+ downloads, leading operations, launch, and user experience execution.",
      "Built and scaled daily newsletter from 0 → 8K+ readers, managing a team of writers and overseeing content production.",
      "Executed across product, marketing, and operations, supporting feature development, onboarding, and retention efforts.",
    ],
  },
  {
    company: "JL Productions - Financial Fortress",
    location: "Las Vegas",
    role: "Project Manager",
    dates: "March 2020 - December 2020",
    period: "Earlier",
    highlights: [
      "Scaled company revenue from ~$350K → $5M+ (~14x) by supporting launch, operations, and delivery.",
      "Increased member retention by ~15% by managing a 2K+ investor community and improving engagement and support systems.",
      "Built SOPs and reporting systems and managed a team of 3 employees & 6 coaches to improve operational efficiency and program delivery.",
    ],
  },
];
